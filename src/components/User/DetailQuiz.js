    ...
    return (
        <>
            <Breadcrumb className="quiz-detail-new-header">
                <NavLink to='/' className='breadcrumb-item'>{t('breadcrumb.home')}</NavLink> {/* Dịch chuỗi */}
                <NavLink to='/users' className='breadcrumb-item'>{t('breadcrumb.users')}</NavLink> {/* Dịch chuỗi */}
                <Breadcrumb.Item active>{t('breadcrumb.quiz')}</Breadcrumb.Item> {/* Dịch chuỗi */}
            </Breadcrumb>
                ...
                <div className="left-content">
                    ...
                    <div className="footer">
                        <button
                            ...
                            onClick={() => handlePrev()}
                        >
                            {t('detailQuiz.prev')} {/* Dịch nút "Prev" */}
                        </button>
                        <button
                            className="btn btn-primary"
                            onClick={() => handleNext()}
                        >
                            {t('detailQuiz.next')} {/* Dịch nút "Next" */}
                        </button>
                        <button
                            className="btn btn-warning"
                            onClick={() => handleFinishQuiz()}
                        >
                            {t('detailQuiz.finish')} {/* Dịch nút "Finish" */}
                        </button>
                    </div>
                </div>
